...
function calc() {
  ...
  function getDynamicInformation(selector) {
    const input = document.querySelector(selector); // делаем проверку если пользователь ввел не число
...
function cards() {
  ...
  Object(_services_services__WEBPACK_IMPORTED_MODULE_0__["getResource"])("http://localhost:3333/menu").then(data => {
    data.forEach(({
      img,
      altimg,
      title,
...
function forms(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    ...
    form.addEventListener("submit", e => {
      ...
      Object(_services_services__WEBPACK_IMPORTED_MODULE_1__["postData"])("http://localhost:3939/requests", json).then(data => {
...
function timer(id, deadline) {
  function getTimeRemaining(endtime) {
    const t = Date.parse(endtime) - Date.parse(new Date()),
          // получим кол-во млсек, которые будут в наше конечное время
...
window.addEventListener("DOMContentLoaded", () => {
  const modalTimerId = setTimeout(() => Object(_modules_modal__WEBPACK_IMPORTED_MODULE_4__["openModal"])(".modal", modalTimerId), 30000);
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])(".timer", "2021-11-12");
